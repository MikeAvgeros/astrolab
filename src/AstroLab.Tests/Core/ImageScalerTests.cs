...
public class ImageScalerTests
{
    ...
    {
        var parameters = new ScaleParameters(BlackPoint: 0, WhitePoint: 10, Mode: mode, AsinhSoftening: 0.1);
    ...
    {
        var parameters = new ScaleParameters(BlackPoint: 0, WhitePoint: 10, Mode: StretchMode.Linear);
    ...
    {
        var parameters = new ScaleParameters(BlackPoint: 0, WhitePoint: 4, Mode: StretchMode.SquareRoot);
    ...
    {
        var parameters = new ScaleParameters(0, 10);
    ...
    {
        var parameters = new ScaleParameters(10, 10);
