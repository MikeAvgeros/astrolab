...
public class SpectrumExtractorTests
{
    ...
    public void ExtractBoxcar_WithFullyCoveredRows_SumsExactRowValues()
    {
        ...
        var result = SpectrumExtractor.ExtractBoxcar(image, 5, 5, DispersionAxis.Horizontal, traceCenters, apertureHalfWidth: 1.0, spectrum);
    ...
    public void ExtractBoxcar_WeightsPartialEdgeCoverage()
    {
        ...
        var result = SpectrumExtractor.ExtractBoxcar(image, 3, 5, DispersionAxis.Horizontal, traceCenters, apertureHalfWidth: 1.0, spectrum);
